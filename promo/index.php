<?php include_once 'header.php' ?>	
	...
	<section id="definition" class="frame" >
		<h1> Thrillderness </h1>
		<p> Sharing the wealth of endangered knowledge. </p>
		<p>Coming 2015</p>
		
		<a id="want-in"> Want in? </a>
		
	</section>
	
	<section id="sign-up" class="frame">
		
	
		<!-- Begin MailChimp Signup Form -->
		<div id="mc_embed_signup">
		<form action="//thrillderness.us3.list-manage.com/subscribe/post?u=5f27a954a3e91c470832a2ec7&amp;id=d8e1ac1bff" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
			<h2>Ok, we'll get you on board.</h2>
		...
		<h2>The Thrillderness Post</h2>
		<p>A concise monthly letter with the most valuable knowledge we can share. <br>
		   <a href="#mc_embed_signup" id="open-address-group">Include your address</a> for a printed annual edition.</p>
		
		
			<div class="mc-address-group">
				<div class="mc-field-group">
				    <label for="mce-MMERGE3-addr1">Address </label>
					<input type="text" value="" placeholder="optional" maxlength="70" name="MMERGE3[addr1]" id="mce-MMERGE3-addr1" class="">
				</div>
				<div class="mc-field-group">
		...
		<li><input type="radio" value="text" name="EMAILTYPE" id="mce-EMAILTYPE-1"><label for="mce-EMAILTYPE-1">text</label></li>
		    ...
		    <div style="position: absolute; left: -5000px;"><input type="text" name="b_5f27a954a3e91c470832a2ec7_d8e1ac1bff" tabindex="-1" value=""></div>
